...
async function getCategoryCounts(): Promise<Record<string, number>> {
  ...
  await Promise.all(
    Object.values(CATEGORY_SLUGS).map(async (slug) => {
...
export default async function HomePage() {
  const [counts, featuredAgents] = await Promise.all([
    getCategoryCounts(),
    getFeaturedAgents(),
  ])
    ...
    <div>
      ...
      <section className="bg-gray-950 border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          ...
          <div className="mt-12 pt-10 border-t border-gray-800 grid grid-cols-2 sm:grid-cols-4 gap-6">
            {[
              { label: 'Agents indexed', value: totalAgents.toString() },
      ...
      <section id="categories" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {Object.entries(CATEGORY_SLUGS).map(([displayName, slug]) => {
