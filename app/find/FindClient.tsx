...
function FindClientInner() {
  ...
  return (
    <>
      {/* Search */}
      <div style={{ background: '#fff', borderBottom: '1px solid #e5e7eb', padding: '0 24px 48px' }}>
...
export default function FindClient() {
  return (
    <Suspense fallback={<div style={{ minHeight: '40vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>Loading...</div>}>
      <FindClientInner />
    </Suspense>
  )
}