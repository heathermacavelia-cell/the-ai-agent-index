...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Automate Sales Outreach with AI Agents (2026)',
    description: '5-step setup guide with domain warm-up, sequence templates, and 6 tools compared. Covers reply rate benchmarks and common mistakes.',
  ...
  twitter: {
    card: 'summary',
    title: 'Automate Sales Outreach with AI Agents (2026)',
    description: '5-step setup guide with domain warm-up, sequence templates, and 6 tools compared.',
  },
  alternates: {
...
const stepTexts = [
  'Define your outreach goal: net-new leads, warm prospects, or re-engagement. Each goal requires a different AI agent.',
  'Choose your AI outreach agent based on your goal. Match the tool to the job and do not run multiple platforms simultaneously.',
  'Build a 4-5 touch sequence with a personalized icebreaker on day 1, follow-up on day 4, LinkedIn on day 7, and breakup on day 12.',
  'Warm up your sending domain for at least two weeks before sending at volume. Set up SPF, DKIM, and DMARC on a dedicated outreach domain.',
  'Track open rates, reply rates, and booked meetings. Optimize one variable at a time to isolate what moves your numbers.',
]
...
const mistakes = [
  ...
  },
  {
    ...
    detail: 'Buyers have learned to spot AI-generated cold email instantly. Personalization based on real prospect signals (a LinkedIn post, a job change, a company announcement) is what separates 1% reply rates from 8%.',
  },
  {
    title: 'Treating sequence length as a performance lever',
    detail: 'Adding more follow-ups rarely solves a low reply rate. More touches on bad copy to the wrong prospect is just more noise. Fix your targeting and personalization before you extend your sequences.',
  },
  {
    title: 'Not connecting outreach activity to CRM',
    detail: (<>Sequence activity that doesn&apos;t sync to your CRM creates a phantom pipeline where reps work leads that the CRM says haven&apos;t been contacted. Set up bidirectional sync to <Link href="/integrations/hubspot" style={{ color: '#2563EB', textDecoration: 'none' }}>HubSpot</Link> or <Link href="/integrations/salesforce" style={{ color: '#2563EB', textDecoration: 'none' }}>Salesforce</Link> before launching any sequence.</>),
  },
]
...
const faqs = [
  ...
  },
  {
    ...
    a: 'A well-optimized campaign with a warmed domain, clean list, and personalized copy typically achieves 3-8% reply rates. Highly personalized campaigns using signal-based icebreakers can reach 10-15%. Generic mass email with no personalization typically gets under 1% and often damages domain reputation in the process.',
  },
  {
    q: 'Is cold email still effective in 2026?',
    a: 'Yes. Cold email remains one of the highest-ROI outbound channels for B2B sales when done correctly. The key is signal-based personalization, clean prospect data, proper deliverability setup, and short focused sequences. AI agents have made it significantly easier to do this at scale, but the fundamentals of good cold email have not changed.',
  },
  {
    q: 'Do I need Clay if I already have Apollo?',
    a: 'It depends on your enrichment requirements. Apollo is a strong all-in-one for most use cases. Clay is better if you need to pull from multiple data sources simultaneously, build custom scoring models, or waterfall across several enrichment providers to maximize contact data coverage. Teams with complex enrichment needs often use both: Apollo for the initial contact database and Clay for enrichment logic upstream.',
  },
  {
...
export default async function HowToAutomateSalesOutreachPage() {
  const meta = await getGuideMeta('how-to-automate-sales-outreach')
  ...
  const jsonLd = {
    ...
    description: '5-step setup guide with domain warm-up, sequence templates, and 6 tools compared.',
    url: 'https://theaiagentindex.com/resources/guides/how-to-automate-sales-outreach',
    step: steps.map((s, i) => ({ '@type': 'HowToStep', name: s.title, text: stepTexts[i] })),
  ...
  const itemListLd = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: 'AI Sales Outreach Tools',
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'lemlist', url: 'https://theaiagentindex.com/agents/lemlist' },
      { '@type': 'ListItem', position: 2, name: 'Instantly.ai', url: 'https://theaiagentindex.com/agents/instantly-ai' },
      { '@type': 'ListItem', position: 3, name: 'Apollo.io', url: 'https://theaiagentindex.com/agents/apollo-io' },
      { '@type': 'ListItem', position: 4, name: 'Clay', url: 'https://theaiagentindex.com/agents/clay' },
      { '@type': 'ListItem', position: 5, name: 'Lavender', url: 'https://theaiagentindex.com/agents/lavender' },
      { '@type': 'ListItem', position: 6, name: 'Gong', url: 'https://theaiagentindex.com/agents/gong' },
    ],
  }
  ...
  return (
    <div style={{ maxWidth: '780px', margin: '0 auto', padding: '3rem 1.5rem 5rem' }}>
      ...
      <div style={{ borderLeft: '3px solid #2563EB', paddingLeft: '1.25rem', marginBottom: '2.5rem' }}>
        ...
        <p style={{ fontSize: '0.8125rem', color: '#9CA3AF', margin: 0 }}>Source: G2 reviewer, Growth Lead, B2B SaaS company</p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '1rem', marginBottom: '3rem' }}>
        {[
          { name: 'lemlist', slug: 'lemlist', desc: 'Best for personalized multichannel sequences' },
          ...
          { name: 'Gong', slug: 'gong', desc: 'Best for analyzing which sequences and messages convert' },
        ].map((tool) => (
      ...
      <div style={{ marginBottom: '2rem' }}>
        <NewsletterSignup sourcePage="guide-how-to-automate-sales-outreach" sourceType="guide" />
      </div>
