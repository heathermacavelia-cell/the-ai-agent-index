...
export const metadata: Metadata = {
  title: 'AI Agents for Insurance: Claims, Underwriting, Fraud (2026)',
  description: 'Talkdesk and Ada for policyholder service, Elicit for compliance, Conversica for lead follow-up. Regulatory requirements covered. Not affiliated.',
...
export default async function BestAIAgentsForInsurance() {
  const meta = await getGuideMeta('best-ai-agents-for-insurance')
  ...
  const jsonLd = {
    ...
    description: 'Talkdesk and Ada for policyholder service, Elicit for compliance, Conversica for lead follow-up. Regulatory requirements covered.',
    url: 'https://theaiagentindex.com/resources/guides/best-ai-agents-for-insurance',
  ...
  const itemListLd = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: 'Best AI Agents for Insurance Companies (2026)',
