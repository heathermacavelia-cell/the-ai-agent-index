...
export const metadata: Metadata = {
  ...
  description: 'Practical guides on how to evaluate, deploy, and build with AI agents.',
}
  ...
  return (
    <div style={{ maxWidth: '900px', margin: '0 auto', padding: '3rem 1.5rem 5rem' }}>
      ...
      <div style={{ backgroundColor: 'white', borderRadius: '0.875rem', border: '1px solid #E5E7EB', padding: '3rem', textAlign: 'center' }}>
        ...
        <h2 style={{ fontWeight: 600, fontSize: '1rem', color: '#111827', marginBottom: '0.5rem' }}>Guides coming soon</h2>
        <p style={{ fontSize: '0.875rem', color: '#6B7280', maxWidth: '400px', margin: '0 auto' }}>
          We're writing guides on topics like how to evaluate AI agents, how to build your first agent, and what makes agents worth paying for.
        </p>
