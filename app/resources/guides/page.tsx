...
const guides = [
  ...
  {
    slug: 'how-ai-agents-are-changing-sales',
    title: 'How AI Agents are Changing Sales in 2026',
    description: 'AI agents are fundamentally reshaping how sales teams prospect, qualify, and close. What is changing and how to adapt.',
    category: 'Sales',
    readTime: '7 min read',
  },
  {
    slug: 'best-ai-agents-for-startups',
    title: 'Best AI Agents for Startups (2026)',
    description: 'The best AI agents for startups — helping founders do more with less across sales, support, research, and content without hiring.',
    category: 'Startups',
    readTime: '6 min read',
  },
  {
    ...
    description: 'How AI agents are transforming ecommerce — covering customer support, personalisation, marketing automation, and order management.',
    category: 'Ecommerce',
    readTime: '6 min read',
  },
  {
    ...
    description: 'The best AI agents for customer support — covering ticket resolution, live chat, escalation management, and omnichannel support automation.',
