...
export const metadata: Metadata = {
  ...
  twitter: {
    card: 'summary',
    title: 'Multi-Agent Orchestration Guide (2026)',
    description: '3 orchestration patterns, 5 frameworks compared, and when single-agent beats multi-agent. Not affiliated.',
  },
  alternates: {
...
export default async function MultiAgentOrchestrationPage() {
  const meta = await getGuideMeta('multi-agent-orchestration')
  ...
  return (
    <div style={{ maxWidth: '780px', margin: '0 auto', padding: '3rem 1.5rem 5rem' }}>
      ...
      <p style={{ fontSize: '1.0625rem', color: '#374151', lineHeight: 1.75, marginBottom: '1.25rem', maxWidth: '700px' }}>
        Multi-agent orchestration coordinates multiple AI agents to work together on a shared goal. Each agent handles a specific subtask, passes outputs to the next agent, and is managed by an orchestrator that sequences the work and handles failures. Anthropic&apos;s December 2024 research note <em>Building Effective Agents</em> defines the canonical pattern: an orchestrator LLM dynamically delegates to worker LLMs and synthesizes their outputs, used for tasks &quot;too long to complete in a single context window&quot; and those that benefit from specialization.
      </p>
        ...
        {[
          ...
          <div key={pattern.name} style={{ backgroundColor: 'white', border: '1px solid #E5E7EB', borderRadius: '0.875rem', overflow: 'hidden' }}>
            ...
            <div style={{ padding: '1.25rem' }}>
              ...
              <p style={{ fontSize: '0.8125rem', color: '#6B7280', fontFamily: 'monospace', backgroundColor: '#F9FAFB', padding: '0.5rem 0.75rem', borderRadius: '0.375rem', marginBottom: '0.75rem' }} dangerouslySetInnerHTML={{ __html: pattern.example }} />
