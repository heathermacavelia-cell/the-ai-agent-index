    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: 'HubSpot is a CRM that stores data for humans to act on. An AI agent takes autonomous action without requiring human input for each step.' },
      },
      {
        '@type': 'Question',
        name: 'Can AI agents replace HubSpot?',
        acceptedAnswer: { '@type': 'Answer', text: 'No. AI agents complement HubSpot. HubSpot is the system of record. AI agents act on that data and write results back to HubSpot.' },
      },
      {
        '@type': 'Question',
        name: 'Which AI agents integrate with HubSpot?',
        acceptedAnswer: { '@type': 'Answer', text: 'Instantly.ai, Apollo.io, Clay, Artisan Ava, and Outreach all integrate natively with HubSpot.' },
      },
      {
        '@type': 'Question',
  ...
  return (
    <div style={{ maxWidth: '780px', margin: '0 auto', padding: '3rem 1.5rem 5rem' }}>
      ...
      <p style={{ fontSize: '0.9375rem', color: '#4B5563', lineHeight: 1.7, marginBottom: '1rem' }}>
        HubSpot is a customer relationship management (CRM) platform. It stores your contacts, companies, deals, and communication history. Sales reps use it to track pipeline, log calls, send sequences, and report on revenue. HubSpot is fundamentally a tool that humans use — it surfaces information and automates reminders, but a human must still decide what to do and take action.
      </p>

      <h2 style={{ fontSize: '1.375rem', fontWeight: 700, color: '#111827', marginBottom: '0.75rem', marginTop: '2.5rem' }}>What is an AI Agent?</h2>
      <p style={{ fontSize: '0.9375rem', color: '#4B5563', lineHeight: 1.7, marginBottom: '1rem' }}>
        An AI agent takes autonomous action to complete a goal without requiring a human to drive each step. In a sales context, an AI agent might identify 500 target accounts, write personalised emails, send them, monitor responses, follow up with non-responders, and route warm leads to a human rep — all without anyone clicking a button.
      </p>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '2.5rem' }}>
        {[
          ...
          { q: 'Which AI agents integrate with HubSpot?', a: 'Instantly.ai, Apollo.io, Clay, Artisan Ava, and Outreach all integrate natively with HubSpot.' },
          { q: 'Do I need HubSpot if I have an AI agent?', a: 'For most teams yes. AI agents need somewhere to store contacts, deals, and emails. HubSpot provides that infrastructure. Small teams may manage temporarily without it, but HubSpot becomes essential as volume grows.' },
        ].map(({ q, a }) => (
