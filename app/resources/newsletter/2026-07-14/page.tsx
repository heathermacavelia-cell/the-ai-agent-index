...
export default function NewsletterIssue01() {
  return (
    <div style={{ maxWidth: '680px', margin: '0 auto', padding: '2.5rem 1.5rem 5rem' }}>
      ...
      <div style={{ fontSize: '0.875rem', color: '#6B7280', marginBottom: '1rem' }}>Issue #1 &middot; July 14, 2026</div>
      ...
      <div style={{ marginTop: '1.5rem', background: '#06171B', borderRadius: '8px', padding: '1rem 1.125rem' }}>
        ...
        <p style={{ fontSize: '0.875rem', lineHeight: 1.55, color: '#E5E7EB', margin: '0.375rem 0 0' }}>
          The post-sales customer context graph. It auto-builds a live account story from 20+ tools, and is one of the very few customer success tools that exposes an MCP server.{' '}
          <a href="https://theaiagentindex.com/agents/noded?utm_source=newsletter_archive" style={{ color: '#6EE7B7', textDecoration: 'underline' }}>Read our independent review &rarr;</a>
        </p>
      </div>
      ...
      <p style={body}>The annual rate on the entry tier dropped by more than half, to $7/seat/mo (month-to-month holds at $20). One of the cheapest ways into a full CRM with AI. <a href="/agents/hubspot-sales-hub" style={linkBlue}>Listing &rarr;</a></p>

      <p style={lede}>Google dropped Gemini&rsquo;s entry plan to $4.99.</p>
      <p style={body}>Google AI Plus fell from $7.99 to $4.99/mo in the US, adding Gemini&rsquo;s paid features at the lowest price point yet. <a href="/agents/gemini" style={linkBlue}>Listing &rarr;</a></p>

      <p style={lede}>Klaviyo moved its marketing agent behind a paywall.</p>
      <p style={body}>Composer, formerly the &ldquo;Marketing Agent&rdquo; and previously part of the base plan, is now a separate add-on listed at <strong>$157/mo</strong> for 16,000 credits. Customer Agent is another $200/mo. Entry email pricing is unchanged at $20/mo. (Both add-ons are currently 30% off on introductory pricing, which will end.) <a href="/agents/klaviyo-ai" style={linkBlue}>Listing &rarr;</a></p>
      ...
      <p style={{ ...body, marginTop: '0.75rem' }}>Whether a tool exposes an MCP server is quickly becoming a real differentiator. <a href="/mcp-servers" style={linkBlue}>See every agent with one &rarr;</a></p>
      ...
      <div style={{ marginTop: '2.25rem', border: '1px solid #E5E7EB', background: '#F9FAFB', borderRadius: '8px', padding: '1.25rem 1.375rem' }}>
        <div style={{ fontSize: '0.6875rem', fontWeight: 700, color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Sponsored &middot; Agent Spotlight</div>
        ...
        <div style={{ marginTop: '1rem', display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '0.75rem' }}>
          <a href="/agents/noded" style={{ display: 'inline-block', background: '#06171B', color: '#FFFFFF', fontSize: '0.875rem', fontWeight: 600, textDecoration: 'none', padding: '0.625rem 1.125rem', borderRadius: '6px' }}>Read our full independent review &rarr;</a>
