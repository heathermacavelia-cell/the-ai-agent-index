  ...
  return (
    <div style={{ maxWidth: '680px', margin: '0 auto', padding: '3rem 1.5rem 5rem' }}>
      ...
      <div style={{ marginTop: '3rem' }}>
        ...
        <a href="/resources/newsletter/2026-09-22" style={{ display: 'block', textDecoration: 'none', border: '1px solid #E5E7EB', borderRadius: '10px', padding: '1.25rem 1.5rem', transition: 'border-color 0.15s', marginBottom: '1rem' }}>
          <div style={{ fontSize: '0.8125rem', color: '#6B7280', marginBottom: '0.375rem' }}>Issue #5 &middot; September 22, 2026</div>
          <div style={{ fontSize: '1.125rem', fontWeight: 700, color: '#111827', lineHeight: 1.35, marginBottom: '0.5rem' }}>Salesforce now owns Fin, and HubSpot Starter went back down</div>
          <div style={{ fontSize: '0.9375rem', color: '#374151', lineHeight: 1.55 }}>Salesforce completed its acquisition of Fin. HubSpot Sales Hub Starter returned to $7 a seat on annual and $10 month to month. Harvey raised $550M and Freshworks made its MCP server generally available.</div>
          <div style={{ fontSize: '0.875rem', fontWeight: 600, color: '#2563EB', marginTop: '0.75rem' }}>Read issue #5 &rarr;</div>
        </a>
        <a href="/resources/newsletter/2026-09-08" style={{ display: 'block', textDecoration: 'none', border: '1px solid #E5E7EB', borderRadius: '10px', padding: '1.25rem 1.5rem', transition: 'border-color 0.15s', marginBottom: '1rem' }}>
          <div style={{ fontSize: '0.8125rem', color: '#6B7280', marginBottom: '0.375rem' }}>Issue #4 &middot; September 8, 2026</div>
          <div style={{ fontSize: '1.125rem', fontWeight: 700, color: '#111827', lineHeight: 1.35, marginBottom: '0.5rem' }}>Salesloft retired the Clari brand, and HubSpot Starter went up</div>
          <div style={{ fontSize: '0.9375rem', color: '#374151', lineHeight: 1.55 }}>clari.com redirects on September 15. HubSpot raised Sales Hub Starter to $9 a seat on annual and $15 month to month. Gemini Spark and Tycoon added MCP, and Copilot Business dropped the sales call.</div>
          <div style={{ fontSize: '0.875rem', fontWeight: 600, color: '#2563EB', marginTop: '0.75rem' }}>Read issue #4 &rarr;</div>
        </a>
