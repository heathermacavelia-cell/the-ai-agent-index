...
export const metadata: Metadata = {
  ...
  description: 'Browse AI agents by the platforms they integrate with. Find the best AI agents for HubSpot, Salesforce, Zapier, Slack, Notion, and more.',
}

const integrations = [
  { slug: 'hubspot', name: 'HubSpot', description: 'CRM, marketing automation, sales sequences', color: '#FF7A59', emoji: '🟠' },
  { slug: 'salesforce', name: 'Salesforce', description: 'Enterprise CRM, Sales Cloud, Service Cloud', color: '#00A1E0', emoji: '🔵' },
  { slug: 'zapier', name: 'Zapier', description: 'Workflow automation, app connectivity', color: '#FF4A00', emoji: '⚡' },
  { slug: 'slack', name: 'Slack', description: 'Team messaging, notifications, workflows', color: '#4A154B', emoji: '💬' },
]
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '1rem' }}>
        {integrations.map((integration) => (
          <Link key={integration.slug} href={'/integrations/' + integration.slug}
            ...
            <h2 style={{ fontWeight: 700, fontSize: '1.0625rem', color: '#111827', marginBottom: '0.375rem' }}>{integration.name}</h2>
