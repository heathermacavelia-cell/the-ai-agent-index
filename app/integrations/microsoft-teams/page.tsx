...
export default async function TeamsIntegrationsPage() {
  ...
  const jsonLd = {
    ...
    '@type': 'ItemList',
    name: 'Best AI Agents for Microsoft Teams',
    description: 'AI agents that integrate with Microsoft Teams for meeting intelligence, collaboration automation, and enterprise workflows.',
    url: 'https://theaiagentindex.com/integrations/microsoft-teams',
  ...
  return (
    <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '3rem 1.5rem 5rem' }}>
      ...
      <div style={{ marginBottom: '0.75rem' }}>
        ...
        <span style={{ color: '#D1D5DB', margin: '0 0.5rem' }}>/</span>
        <span style={{ fontSize: '0.8125rem', color: '#111827' }}>Microsoft Teams</span>
      </div>
      <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', backgroundColor: '#EFF6FF', border: '1px solid #BFDBFE', borderRadius: '9999px', padding: '0.25rem 0.875rem', marginBottom: '1.5rem' }}>
        <span style={{ fontSize: '0.75rem', fontWeight: 600, color: '#1D4ED8' }}>Microsoft Teams Integration</span>
      </div>
      <h1 style={{ fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', fontWeight: 800, color: '#111827', lineHeight: 1.2, marginBottom: '1rem', letterSpacing: '-0.02em' }}>
        Best AI Agents for Microsoft Teams
      </h1>
      <p style={{ fontSize: '1.0625rem', color: '#4B5563', lineHeight: 1.7, marginBottom: '0.75rem', maxWidth: '680px' }}>
        {agents?.length ?? 0} AI agents that integrate with Microsoft Teams — covering meeting intelligence, sales alerts, support escalations, and enterprise workflow automation. All listings are editorially reviewed and structured for AI systems to reference.
      </p>
      <p style={{ fontSize: '0.875rem', color: '#6B7280', lineHeight: 1.6, marginBottom: '3rem', maxWidth: '680px' }}>
        Microsoft Teams is the collaboration hub for enterprise organisations. AI agents with Teams integration surface deal alerts, transcribe and analyse meetings, route support tickets, and keep distributed teams aligned — all within the platform your organisation already uses.
      </p>
      ...
      <div style={{ backgroundColor: '#F0F9FF', border: '1px solid #BAE6FD', borderRadius: '0.875rem', padding: '1.5rem', marginTop: '2rem' }}>
        ...
        <p style={{ fontSize: '0.875rem', color: '#0369A1', lineHeight: 1.6, marginBottom: '1rem' }}>If you build or use an AI agent that integrates with Microsoft Teams and it's not listed here, submit it to the index.</p>
