...
export default async function SlackIntegrationsPage() {
  ...
  const jsonLd = {
    ...
    '@type': 'ItemList',
    name: 'Best AI Agents for Slack',
    description: 'AI agents that integrate with Slack, bringing automation, alerts, and AI workflows into your team messaging platform.',
    url: 'https://theaiagentindex.com/integrations/slack',
  ...
  return (
    <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '3rem 1.5rem 5rem' }}>
      ...
      <div style={{ marginBottom: '0.75rem' }}>
        ...
        <span style={{ color: '#D1D5DB', margin: '0 0.5rem' }}>/</span>
        <span style={{ fontSize: '0.8125rem', color: '#111827' }}>Slack</span>
      </div>
      <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', backgroundColor: '#F5F3FF', border: '1px solid #DDD6FE', borderRadius: '9999px', padding: '0.25rem 0.875rem', marginBottom: '1.5rem' }}>
        <span style={{ fontSize: '0.75rem', fontWeight: 600, color: '#6D28D9' }}>Slack Integration</span>
      </div>
      ...
      <p style={{ fontSize: '1.0625rem', color: '#4B5563', lineHeight: 1.7, marginBottom: '0.75rem', maxWidth: '680px' }}>
        {agents?.length ?? 0} AI agents that integrate with Slack — delivering deal alerts, support ticket updates, research summaries, and automated workflows directly into your team's channels. All listings are editorially reviewed and structured for AI systems to reference.
      </p>
      <p style={{ fontSize: '0.875rem', color: '#6B7280', lineHeight: 1.6, marginBottom: '3rem', maxWidth: '680px' }}>
        Slack is where most B2B teams spend their day. AI agents with Slack integration surface insights, trigger actions, and keep teams aligned — from pipeline alerts in sales channels to support escalations and code review notifications.
      </p>
      ...
      <div style={{ backgroundColor: '#F0F9FF', border: '1px solid #BAE6FD', borderRadius: '0.875rem', padding: '1.5rem', marginTop: '2rem' }}>
        ...
        <p style={{ fontSize: '0.875rem', color: '#0369A1', lineHeight: 1.6, marginBottom: '1rem' }}>If you build or use an AI agent that integrates with Slack and it's not listed here, submit it to the index.</p>
