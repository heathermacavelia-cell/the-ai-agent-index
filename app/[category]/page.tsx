...
const CATEGORY_META: Record<string, {
  ...
  'ai-research-agents': {
    ...
    bgColor: '#FFFBEB',
    borderColor: '#FDE68A',
    metaTitle: 'Best AI Research Agents (2026): 40+ Compared',
    metaDescription: '40+ AI research agents compared: Perplexity, Elicit, Consensus, Harvey AI, NotebookLM. Independent ratings, verified pricing, integration depth. Not affiliated.',
