...
const CATEGORY_META: Record<string, {
  ...
  'ai-sales-agents': {
    ...
    bgColor: '#F0FDF4',
    borderColor: '#BBF7D0',
    metaTitle: 'Best AI Sales Agents (2026): 50+ Ranked With Pricing',
    metaDescription: 'Apollo, Gong, Artisan Ava, Instantly, and Outreach compared. Editorial ratings, verified pricing, and autonomy data. Updated weekly. Not affiliated.',
  ...
  'ai-customer-support-agents': {
    ...
    bgColor: '#FAF5FF',
    borderColor: '#E9D5FF',
    metaTitle: 'Best AI Support Agents (2026): Resolution Rates Ranked',
    metaDescription: 'Intercom Fin, Zendesk AI, Sierra, and Ada compared. Autonomous resolution rates, per-ticket pricing, and integration depth reviewed. Not affiliated.',
  ...
  'ai-research-agents': {
    ...
    bgColor: '#FFFBEB',
    borderColor: '#FDE68A',
    metaTitle: 'Best AI Research Agents (2026): 40+ With Pricing',
    metaDescription: 'Perplexity, Elicit, Consensus, Harvey AI, and NotebookLM compared. Editorial ratings, verified pricing, and citation quality reviewed. Not affiliated.',
  ...
  'ai-marketing-agents': {
    ...
    bgColor: '#FFF1F2',
    borderColor: '#FECDD3',
    metaTitle: 'Best AI Marketing Agents (2026): Content, SEO, Ads',
    metaDescription: 'Writesonic, Jasper, Copy.ai, and Surfer SEO compared. Brand voice, SEO depth, and campaign automation reviewed with pricing. Not affiliated.',
  ...
  'ai-coding-agents': {
    ...
    bgColor: '#EFF6FF',
    borderColor: '#BFDBFE',
    metaTitle: 'Best AI Coding Agents (2026): IDEs, Terminals, Autonomous',
    metaDescription: 'Cursor, GitHub Copilot, Claude Code, and OpenHands compared. Autonomy benchmarks, pricing, and IDE integration depth reviewed. Not affiliated.',
  ...
  'ai-hr-agents': {
    ...
    bgColor: '#F0FDFA',
    borderColor: '#99F6E4',
    metaTitle: 'Best AI HR Agents (2026): Hiring, Payroll, Compliance',
    metaDescription: 'Deel, Rippling, Ashby, Greenhouse, and Workday compared. Verified pricing, global compliance coverage, and integration depth reviewed. Not affiliated.',
  ...
  'ai-workflow-agents': {
    ...
    bgColor: '#FFF7ED',
    borderColor: '#FDBA74',
    metaTitle: 'Best AI Workflow Agents (2026): Zapier, Make, n8n',
    metaDescription: 'Zapier, Make, n8n, Skyvern, and Lindy compared. Pricing, integration count, and self-hosting options reviewed. Updated weekly. Not affiliated.',
  ...
  'ai-customer-success-agents': {
    ...
    bgColor: '#F0F9FF',
    borderColor: '#BAE6FD',
    metaTitle: 'Best AI Customer Success Agents (2026): Churn, Renewal',
    metaDescription: 'Gainsight, ChurnZero, Vitally, Planhat, and Totango compared. Health scoring, churn prediction, and renewal automation reviewed. Not affiliated.',
    ...
    <div>
      ...
      <section style={{ backgroundColor: meta?.bgColor ?? '#F9FAFB', borderBottom: '1px solid', borderColor: meta?.borderColor ?? '#E5E7EB', padding: '3rem 1.5rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          {/* Category Sponsor — premium placement, first thing buyers see */}
            ...
            <>
              <style>{`
                ...
                @media (max-width: 768px) {
                  ...
                  .ep-card-price { font-size: 0.6875rem; color: #6B7280; margin-top: 0.125rem; }
