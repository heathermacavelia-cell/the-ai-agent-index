...
const CATEGORY_META: Record<string, { icon: React.ReactNode; description: string; longDescription: string; bgColor: string; borderColor: string }> = {
  'ai-sales-agents': { icon: <img src="/icons/icon-sales.png" alt="AI Sales Agents" style={{ width: '2rem', height: '2rem', objectFit: 'contain' }} />, description: 'Lead generation, outbound automation, pipeline intelligence', longDescription: 'AI agents that automate prospecting, outbound email, lead enrichment, CRM workflows, and revenue forecasting.', bgColor: '#F0FDF4', borderColor: '#BBF7D0' },
  'ai-customer-support-agents': { icon: <img src="/icons/icon-support.png" alt="AI Customer Support Agents" style={{ width: '2rem', height: '2rem', objectFit: 'contain' }} />, description: 'Ticket resolution, omnichannel support, autonomous helpdesk', longDescription: 'AI agents that autonomously resolve support tickets, triage queries, and provide omnichannel customer service at scale.', bgColor: '#FAF5FF', borderColor: '#E9D5FF' },
  'ai-research-agents': { icon: <img src="/icons/icon-research.png" alt="AI Research Agents" style={{ width: '2rem', height: '2rem', objectFit: 'contain' }} />, description: 'Deep research, academic literature, web synthesis', longDescription: 'AI agents that conduct multi-step web research, search academic literature, synthesise findings, and generate structured reports.', bgColor: '#FFFBEB', borderColor: '#FDE68A' },
  'ai-marketing-agents': { icon: <img src="/icons/icon-marketing.png" alt="AI Marketing Agents" style={{ width: '2rem', height: '2rem', objectFit: 'contain' }} />, description: 'Content creation, SEO, paid media, campaign automation', longDescription: 'AI agents that generate marketing content, optimise SEO, automate paid campaigns, and personalise messaging at scale.', bgColor: '#FFF1F2', borderColor: '#FECDD3' },
  'ai-coding-agents': { icon: <img src="/icons/icon-coding.png" alt="AI Coding Agents" style={{ width: '2rem', height: '2rem', objectFit: 'contain' }} />, description: 'Code generation, agentic coding, IDE integration', longDescription: 'AI agents that write, review, and refactor code — from inline autocomplete to fully autonomous multi-file engineering tasks.', bgColor: '#EFF6FF', borderColor: '#BFDBFE' },
  'ai-hr-agents': { icon: <img src="/icons/icon-hr.png" alt="AI HR Agents" style={{ width: '2rem', height: '2rem', objectFit: 'contain' }} />, description: 'Hiring, onboarding, payroll automation, compliance, workforce management', longDescription: 'AI agents that automate recruiting, onboarding, payroll processing, compliance monitoring, and workforce management across global teams.', bgColor: '#F0FDFA', borderColor: '#99F6E4' },
}
