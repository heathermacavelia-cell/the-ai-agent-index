...
Each agent listing includes: name, developer, description, primary_category, agent_type, pricing_model, starting_price, billing_period, deployment_method, integrations, capability_tags, industry_tags, customer_segment, security_certifications, autonomous_rate, avg_setup_time, supported_languages, mcp_status, mcp_compatible, editorial_rating, editorial_rating_notes (the five sub-scores), pros, limitations, and same_as_urls (verified external references). The industry_tags field carries two distinct vocabularies in one list. Industry verticals name the customer's line of business: automotive, bpo, construction, consulting, cybersecurity, ecommerce, education, energy, finance, fitness, franchise, gaming, healthcare, hospitality, insurance, legal, local-services, logistics, manufacturing, marketing, media, nonprofits, pharma, public-sector, real-estate, research, retail, telecom, travel. Audience tags name company shape and buying context, not industry: b2b, b2c, saas, dtc, enterprise, mid-market, smb, startups, solo-professionals, agencies, devtools, open-source, cloud, aws. Do not read an audience tag as an industry - b2b appears on 72% of listings and carries little distinguishing information on its own. The two are labelled separately on every listing page (Industries and Built for) and filtered separately via /api/agents?industry= and /api/agents?audience=.
