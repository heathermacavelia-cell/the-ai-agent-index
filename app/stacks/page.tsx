...
export const metadata: Metadata = {
  ...
  description: 'Browse curated and community-verified AI agent stacks. Find the right combination of agents to automate your full business workflow — sales, support, research, marketing, coding, and HR.',
      ...
      <section style={{ maxWidth: '1100px', margin: '0 auto', padding: '4rem 1.5rem 2rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '1rem', marginBottom: '0.75rem' }}>
          <h1 style={{ fontSize: 'clamp(1.75rem, 4vw, 2.75rem)', fontWeight: 800, letterSpacing: '-0.02em', margin: 0 }}>
            Multi-agent workflows for business automation
          </h1>
        ...
        <p style={{ color: '#9CA3AF', fontSize: '1rem', lineHeight: 1.7, maxWidth: '640px' }}>
          Curated and community-verified combinations of AI agents that work together to automate complete business workflows. Not just tools — proven sequences.
        </p>
      </section>
