"use strict";(()=>{var e={};e.id=4508,e.ids=[4508],e.modules={30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},34455:(e,t,r)=>{r.r(t),r.d(t,{headerHooks:()=>g,originalPathname:()=>y,patchFetch:()=>f,requestAsyncStorage:()=>p,routeModule:()=>h,serverHooks:()=>d,staticGenerationAsyncStorage:()=>m,staticGenerationBailout:()=>_});var a={};r.r(a),r.d(a,{POST:()=>l,dynamic:()=>u});var n=r(95419),s=r(69108),i=r(99678),o=r(78070),c=r(8234);let u="force-dynamic";async function l(e){try{let t;let{query:r}=await e.json();if(!r||r.trim().length<5)return o.Z.json({error:"Please describe what you want to automate"},{status:400});let a=(0,c.eI)(),{data:n,error:s}=await a.from("agents").select("name, slug, short_description, primary_category, capability_tags, industry_tags, integrations, pricing_model, customer_segment").eq("is_active",!0).limit(250);if(s||!n)return o.Z.json({error:"Failed to fetch agents"},{status:500});let i=`You are an AI agent matching expert for The AI Agent Index. A business owner has described what they want to automate. Find the best matching AI agents from the directory.
