      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem' }}>
          ...
          <div className="agent-hero-top" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '1.5rem', marginBottom: '1.25rem', flexWrap: 'wrap' }}>
            ...
            {agent.website_url && (
              <a href={agent.website_url} target="_blank" rel="noopener noreferrer"
                style={{ flexShrink: 0, display: 'inline-flex', alignItems: 'center', padding: '0.625rem 1.5rem', borderRadius: '0.5rem', backgroundColor: '#111827', color: 'white', fontSize: '0.875rem', fontWeight: 600, textDecoration: 'none', letterSpacing: '0.01em', transition: 'background-color 0.15s' }}>
                Visit site →
              </a>
            )}
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '0.75rem' }}>
                  ...
                  {similarAgents.map(function(similar: SimilarAgent) {
                    return (
                      <Link key={similar.slug} href={'/agents/' + similar.slug}
                        style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.75rem', borderRadius: '0.5rem', border: '1px solid #F3F4F6', textDecoration: 'none', backgroundColor: '#FAFAFA', transition: 'border-color 0.15s' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            {/* Rating card */}
            <a href="#reviews" style={{ display: 'block', backgroundColor: 'white', borderRadius: '0.75rem', border: '1px solid #E5E7EB', padding: '1.25rem', textDecoration: 'none', transition: 'border-color 0.15s' }}>
              ...
              <p style={{ fontSize: '0.75rem', marginTop: '0.375rem', color: ratingCount > 0 ? '#2563EB' : '#9CA3AF', margin: '0.375rem 0 0' }}>
            ...
            <Link href={'/stacks?agent=' + agent.slug}
              style={{ display: 'block', backgroundColor: 'white', borderRadius: '0.75rem', border: '1px solid #E5E7EB', padding: '1.25rem', textDecoration: 'none', transition: 'border-color 0.15s' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.25rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
                  {similarAgents.slice(0, 3).map((similar: SimilarAgent) => (
                    <Link key={similar.slug} href={'/compare/' + agent.slug + '-vs-' + similar.slug}
                      style={{ fontSize: '0.8125rem', color: '#2563EB', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.5rem 0.625rem', borderRadius: '0.375rem', backgroundColor: '#F9FAFB', border: '1px solid #F3F4F6', transition: 'border-color 0.15s' }}>
